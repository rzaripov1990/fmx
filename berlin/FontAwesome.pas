...
begin
  ...
  begin
    ...
    aListClass.ItemAppearanceObjects.ItemObjects.Text.Font.Family := FontAwesomeName;
    aListClass.ItemAppearanceObjects.ItemObjects.Detail.Font.Family := FontAwesomeName;
  end
