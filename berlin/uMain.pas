...
uses
  ...
  FMX.Types, FMX.Controls, FMX.Forms, FMX.Graphics, FMX.Dialogs, FMX.StdCtrls, FMX.Controls.Presentation, FMX.ListView.Types,
...
const
  MAXARRAY = 5;
  TLVMenuItems: array [0 .. MAXARRAY] of string = ('Город', 'Акции и бонусы', 'Мои заказы', 'О нас', 'Обратная связь',
    'Настройка');
  TLVMenuItemsSymb: array [0 .. MAXARRAY] of string = (fa_map_marker, fa_certificate, fa_list, fa_info_circle,
    fa_envelope, fa_cog);
var
  i: Integer;
begin
...
begin
  ...
  Text1.Font.Size := 20;
  Text1.Text := 'FontAwesome: ' + #13#10 + fa_flag + ' One Font, 605 Icons' + #13#10 + fa_eye + ' Perfect on Retina Displays' +
    #13#10 + fa_desktop + ' Desktop Friendly';
end;
