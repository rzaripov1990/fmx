...
uses
  FMX.FontGlyphs, Androidapi.JNI.GraphicsContentViewText, Androidapi.JNIBridge, System.IOUtils;
  ...
  try
    ...
    try
      ...
      try
        ...
        Result := TFontGlyph.Create(TPoint.Create(Bounds.left, OriginY), Advance, Abs(FAscent) + Abs(FDescent) + Abs(FLeading),
          GlyphStyle);
